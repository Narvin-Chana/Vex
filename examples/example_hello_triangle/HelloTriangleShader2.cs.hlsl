...
{
    uint width, height;
    RWTexture2D<float4> sourceTexture = GetBindlessTexture(CB.outputBindlessIndex);
    RWTexture2D<float4> outputTexture = GetBindlessTexture(CB.outputBindlessIndex2);
