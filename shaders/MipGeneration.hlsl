...
float4 SampleAt(uint3 coord, float2 uv)
{
    ...
    if (MipUniforms.textureDimension == TEXTURE_DIMENSION_2D)
    {
    ...
    else if (MipUniforms.textureDimension == TEXTURE_DIMENSION_2DARRAY)
    {
    ...
    else if (MipUniforms.textureDimension == TEXTURE_DIMENSION_CUBE)
    {
    ...
    else if (MipUniforms.textureDimension == TEXTURE_DIMENSION_CUBEARRAY)
    {
    ...
    else if (MipUniforms.textureDimension == TEXTURE_DIMENSION_3D)
    {
...
float4 SampleWithNPOT(uint3 coord)
{
    ...
    if (MipUniforms.textureDimension == TEXTURE_DIMENSION_3D)
    {
