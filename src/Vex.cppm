...
using vex::CullMode;
using vex::DepthStencilBinding;
using vex::DepthStencilState;
using vex::DescriptorType;
using vex::DrawDesc;
...
using vex::Handle32;
using vex::Handle64;
using vex::IndexBufferBinding;
using vex::IndexFormat;
