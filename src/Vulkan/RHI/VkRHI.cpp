...
VkRHI::VkRHI(const PlatformWindowHandle& windowHandle, bool enableGPUDebugLayer, bool enableGPUBasedValidation)
{
...
#if defined(_WIN32)
        ValidateAndAddExtension(VK_KHR_WIN32_SURFACE_EXTENSION_NAME);
#elif defined(__linux__)
#if defined(VK_USE_PLATFORM_XLIB_KHR)
        ValidateAndAddExtension(VK_KHR_XLIB_SURFACE_EXTENSION_NAME);
#endif
#if defined(VK_USE_PLATFORM_WAYLAND_KHR)
        ValidateAndAddExtension(VK_KHR_WAYLAND_SURFACE_EXTENSION_NAME);
#endif
#endif
    }
    ...
    if (enableGPUDebugLayer)
    {
        ...
        ValidateAndAddExtension(VK_EXT_DEBUG_UTILS_EXTENSION_NAME);
    }
...
void VkRHI::Init()
{
    ...
    ValidateAndAddExtension(VK_KHR_ROBUSTNESS_2_EXTENSION_NAME);
    ValidateAndAddExtension(VK_GOOGLE_USER_TYPE_EXTENSION_NAME);
    ValidateAndAddExtension(VK_KHR_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME);
