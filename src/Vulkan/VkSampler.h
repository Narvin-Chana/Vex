...
inline VEX_VK_BEGIN_ENUM_MAPPING(FilterMode, FilterMode, ::vk::Filter, VkFilter)
...
inline VEX_VK_BEGIN_ENUM_MAPPING(FilterMode, FilterMode, ::vk::SamplerMipmapMode, VkMipMapMode)
VEX_VK_ENUM_MAPPING_ENTRY(Linear, eLinear)
VEX_VK_ENUM_MAPPING_ENTRY(Point, eNearest)
VEX_VK_ENUM_MAPPING_ENTRY(Anisotropic, eLinear)
VEX_VK_END_ENUM_MAPPING

inline VEX_VK_BEGIN_ENUM_MAPPING(BorderColor, BorderColor, ::vk::BorderColor, VkBorderColor)
