...
template <class T>
    requires(std::derived_from<T, vex::Handle32<T>> or std::derived_from<T, vex::Handle64<T>>)
struct std::hash<T>
{
...
template <class T>
    requires(std::derived_from<T, vex::Handle32<T>> || std::derived_from<T, vex::Handle64<T>>)
