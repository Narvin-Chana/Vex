...
static void reset(std::array<uint32_t, 5>& digest, std::string& buffer, uint64_t& transforms)
{
...
static void transform(std::array<uint32_t, 5>& digest, uint32_t block[BLOCK_INTS], uint64_t& transforms)
{
...
std::array<uint32_t, 5> SHA1::final()
{
