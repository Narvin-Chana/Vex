...
void ResourceCleanup::CleanupResource(TCleanupVariant resource, i8 lifespan)
{
...
void ResourceCleanup::FlushResources(i8 flushCount)
{
    ...
    std::erase_if(resourcesInFlight, [](const std::pair<TCleanupVariant, i8>& val) { return val.second == 0; });
}
