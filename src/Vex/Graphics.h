...
public:
    ...
    [[deprecated("Prefer to use the version with an out parameter (see below) to avoid allocations in your "
                 "hotpath.")]] [[nodiscard]] std::vector<BindlessHandle>
    GetBindlessHandles(Span<const ResourceBinding> bindlessResources);
