...
struct DX12TextureView
{
    ...
    // Uses resource format if UNKNOWN (and the texture's format is not TYPELESS)
...
private:
    void CreateViews(ComPtr<DX12Device>& device);
    ...
    FreeListAllocator srvUavHeapAllocator;
